...
This must be internally consistent with leakage_pattern and sales_quality_read — never pick a classification that contradicts the leakage location you just named. First decide which of these two situations you are actually looking at, because they lead to different classifications:
